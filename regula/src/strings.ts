...
const en: Table = {
  ...
  trayPause: "Pause reactions",
  trayResume: "Resume reactions",
  trayDesktop: "Show on desktop",
  trayClickThrough: "Let clicks pass through",
  trayPopups: "Show notes while hidden",
  traySettings: "Settings…",
  trayHelp: "About regula.dot",
...
const de: Table = {
  ...
  trayPause: "Reaktionen pausieren",
  trayResume: "Reaktionen fortsetzen",
  trayDesktop: "Auf dem Desktop zeigen",
  trayClickThrough: "Klicks durchlassen",
  trayPopups: "Hinweise zeigen, wenn verborgen",
  traySettings: "Einstellungen…",
  trayHelp: "Über regula.dot",
